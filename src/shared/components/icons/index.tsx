...
export const AiChatIcon: React.FC = React.memo(() => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
      {/* Modern chat bubble with AI sparkle */}
      <path d="M12 2C6.477 2 2 6.145 2 11.25c0 1.807.553 3.485 1.493 4.897L2.05 20.8a.75.75 0 00.95.95l4.653-1.443A10.93 10.93 0 0012 21.5c5.523 0 10-4.145 10-9.25S17.523 2 12 2z" />
      {/* AI sparkle dots */}
